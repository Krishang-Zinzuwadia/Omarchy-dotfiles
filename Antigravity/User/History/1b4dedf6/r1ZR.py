...
class PipelineCalculatorAgent:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.runner = create_pipeline_runner(
                ...
                confidence_threshold=0.4  # Lower threshold for calculator
            )
    ...
    def execute_command(self, command: str) -> Dict[str, Any]:
        ...
        try:
            ...
            user_instruction = f"Click the buttons to calculate {calculation_found}. Click each digit and operator button individually."
