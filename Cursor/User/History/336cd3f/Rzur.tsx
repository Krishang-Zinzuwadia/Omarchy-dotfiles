    ...
    if (!process.env.DATABASE_URL) {
        const mockPastPapers = [
            ...
            },
            {
                ...
                authorId: 'dev-user',
                tags: [
                    { id: '3', name: 'CAT 2', aliases: [], createdAt: new Date(), updatedAt: new Date() },
                    { id: '4', name: 'B1', aliases: [], createdAt: new Date(), updatedAt: new Date() }
                ]
            }
        ];
        ...
        return (
            <div className="p-8 transition-colors flex flex-col min-h-screen items-center text-black dark:text-[#D5D5D5]">
                ...
                <div className="mt-8">
                    <Pagination currentPage={validatedPage} totalPages={totalPages} />
                </div>
            </div>
        );
    }
