...
export default async function ResourcesPage({ searchParams }: { searchParams: Promise<{ page?: string, search?: string }> }) {
    ...
    if (!process.env.DATABASE_URL) {
        const mockSubjects = [
            ...
            {
                id: '2', 
                name: 'CS102 - Computer Networks',
                modules: []
            },
            {
                id: '3',
                name: 'CS103 - Database Management Systems',
                modules: []
            },
            {
                id: '4',
        ...
        return (
            <div className="transition-colors min-h-screen text-black dark:text-gray-200 bg-[#C2E6EC] dark:bg-[#0C1222]">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <h1 className="text-center mb-8">Resource Repo (Development Mode)</h1>
